...
export const metadata: Metadata = {
  ...
  description:
    "This portfolio itself: Next.js 16 + TypeScript + Tailwind, redesigned from basic dark+teal to stunning Obsidian Aurora editorial — amber #FFB224 + violet #8B5CF6, Instrument Serif, glass + noise + aurora, rounded-full pills, no blank spaces, 14/14 static pages.",
        ...
        <article className="mx-auto max-w-4xl">
          <CaseSection id="overview" eyebrow="01" title="Overview">
            <p>
              ...
              obsidian #050507 + warm paper #FFFDFA contrast, amber #FFB224 signal + violet #8B5CF6 depth,
          ...
          <CaseSection id="before-after" eyebrow="02" title="Before → After">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="panel p-5 border-accent/20 bg-accent/[0.04]">
                ...
                <ul className="mt-3 space-y-1.5 text-[13px] text-ink-med">
                  <li>• Obsidian #050507 + paper #FFFDFA + amber + violet</li>
          ...
          <CaseSection id="system" eyebrow="03" title="Design system">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-3">
              {[
                { k: "Colors", v: "#050507 obsidian, #FFFDFA paper, #FFB224 amber, #8B5CF6 violet, #06B6D4 cyan" },
