# Security Policy — Portfolio — Cybersecurity Hardened
...
1. **GitHub Security Advisory (Preferred — Private):**
   https://github.com/Nyaenya-Devine/portfolio/security/advisories/new
   - Encrypted, private, allows CVSS, CWE, credit

2. **Email (if advisory not possible):**
   devinenyaenya@gmail.com — PGP optional, subject `[Portfolio Security]`
...
```md
![CI](https://github.com/Nyaenya-Devine/portfolio/actions/workflows/ci.yml/badge.svg)
![Security](https://github.com/Nyaenya-Devine/portfolio/actions/workflows/security.yml/badge.svg)
![CodeQL](https://github.com/Nyaenya-Devine/portfolio/actions/workflows/security.yml/badge.svg?event=schedule)
![Electron Release](https://github.com/Nyaenya-Devine/portfolio/actions/workflows/electron-release.yml/badge.svg)
```
